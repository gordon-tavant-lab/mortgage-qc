...
> **REFRESH NOTICE (2026-08-01, resolve6 pass):** the verdict counts in this narrative are
> superseded. After resolving the six NOT_COMPILED categories (see
> `output/RESOLVE6-NOT-COMPILED-RESOLUTION-2026-08-01.md`), the current distribution is
> **PASS 130 · NEEDS_REVIEW 92 · NOT_APPLICABLE 284 · NOT_COMPILED 599** (evaluated checks
> 256 → 506). The companion Excel workbook and the per-row CSV export have been regenerated
> and ARE current. Everything else in this narrative (the AMQ baseline, scope funnel,
> reason-category definitions, honesty callouts) still stands.
